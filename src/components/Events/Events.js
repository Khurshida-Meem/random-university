            ...
            <Row xs={1} md={2} className="g-4 mt-5">
                ...
                <Col>
                    <Card>
                        ...
                        <Card.Body>
                            ...
                            <p className='dark-text'>at Tech Building, <strong><i className="far fa-clock secondary-text"></i> at 3:00 pm</strong> </p>
                ...
                <Col>
                    <Card>
                        ...
                        <Card.Body>
                            ...
                            <p className='dark-text'>Online <strong><i className="far fa-clock secondary-text"></i> at 6:00 pm</strong> </p>
                ...
                <Col>
                    <Card>
                        ...
                        <Card.Body>
                            ...
                            <p className='dark-text'>at Tech Building <strong><i className="far fa-clock secondary-text"></i> at 9:00 am</strong> </p>
                ...
                <Col>
                    <Card>
                        ...
                        <Card.Body>
                            <h2 className='secondary-text'>Annual Culturul Fest</h2>
                            <p className='dark-text'>
                                LaTeX is a high-quality typesetting system; it includes features designed for the production of technical and scientific documentation.
                            </p>
                            ...
                            <p className='dark-text'>at Auditoriam <strong ><i className="far fa-clock secondary-text"></i> 10:00 am</strong> </p>
